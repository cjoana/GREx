...
class InitialMetricData
{
  public:
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        data_t amplitude = m_params.amplitude;
        ...
        data_t h12 = 0. + amplitude * sin( coords.x * 2*M_PI/m_params.L   +  M_PI*0.3)
                        + amplitude * sin( coords.y * 2*M_PI/m_params.L   +  M_PI*0.3) 
                        + amplitude * sin( coords.z * 2*M_PI/m_params.L   +  M_PI*0.3);
        data_t h13 = 0. + amplitude * 0.1 * sin( coords.x * 2*M_PI/m_params.L   +  M_PI*0.5) 
                        + amplitude * 0.1 * sin( coords.y * 2*M_PI/m_params.L   +  M_PI*0.5) 
                        + amplitude * 0.1 * sin( coords.z * 2*M_PI/m_params.L   +  M_PI*0.5); 
        data_t h23 = 0. + amplitude * 0.3 * sin( coords.x * 2*M_PI/m_params.L   +  M_PI*0.9)
                        + amplitude * 0.3 * sin( coords.y * 2*M_PI/m_params.L   +  M_PI*0.9) 
                        + amplitude * 0.3 * sin( coords.z * 2*M_PI/m_params.L   +  M_PI*0.9);
        ...
        current_cell.store_vars(h12/detH, c_h12);
        current_cell.store_vars(h13/detH, c_h13);
        current_cell.store_vars(h22/detH, c_h22);
        current_cell.store_vars(h23/detH, c_h23);
        current_cell.store_vars(h33/detH, c_h33);
        ...
        current_cell.store_vars(0, c_K);
        current_cell.store_vars(1.0, c_chi);
        current_cell.store_vars(2.0, c_phi); // for now set to 0
