...
template <class data_t> data_t compute_trace(const Tensor<2, data_t> &tensor_UL)
{
    data_t trace = 0.;
...
template <class data_t>
data_t compute_dot_product(const Tensor<1, data_t> &covector1_L,
                           const Tensor<1, data_t> &covector2_L,
                           const Tensor<2, data_t> &inverse_metric)
{
    data_t dot_product = 0.;
    FOR(m, n)
...
template <class data_t>
Tensor<1, data_t> raise_all(const Tensor<1, data_t> &tensor_L,
                            const Tensor<2, data_t> &inverse_metric)
{
...
template <class data_t>
Tensor<2, data_t> raise_all(const Tensor<2, data_t> &tensor_LL,
                            const Tensor<2, data_t> &inverse_metric)
{
