...
#ifndef SCALARFIELDNEXTTOPBHLEVEL_HPP_
#define SCALARFIELDNEXTTOPBHLEVEL_HPP_
...
//!  A class for the evolution of a real scalar field next to 
//!  a Schwarzchild Black Hole, minimally coupled to gravity
/*!
...
*/
class ScalarFieldnexttoPBHLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<ScalarFieldnexttoPBHLevel>;
...
#endif /* SCALARFIELDNEXTTOPBHLEVEL_HPP_ */
