...
def get_rhs_K(r_here, lapse, K, Asquared, em4phi, d2lapsedr2, dlapsedr, 
    ...
    # DEBUG CJ TODO
    # if r_here == 1:
    #     lapseterm = - em4phi * (bar_D2_lapse + 2.0 * r_gamma_UU[i_r][i_r] * dlapsedr * dphidr)
    #     print("D2_lapse:",  lapseterm)
    #     geo = one_third * lapse * K * K  + lapse * Asquared 
    #     print('  gep', geo)
    #     mat = + 0.5 * eight_pi_G * lapse * (rho + S)
    #     print('  mat', mat)
