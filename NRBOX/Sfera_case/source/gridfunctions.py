...
def unpack_state(vars_vec, N_r) :
    ...
    Aa    = vars_vec[idx_Aa * domain_length : (idx_Aa + 1) * domain_length]
    ...
    psy    = vars_vec[idx_psy * domain_length : (idx_psy + 1) * domain_length]
    Pi    = vars_vec[idx_Pi * domain_length : (idx_Pi + 1) * domain_length]
    
    return chi, a, b, K, Aa, AX, X, Lambda, lapse, beta, br, phi, psy, Pi 

def pack_state(vars_vec, N_r,chi, a, b, K, Aa, AX, X, Lambda, lapse, beta, br, phi, psy, Pi) :
    ...
    vars_vec[idx_Aa * domain_length : (idx_Aa + 1) * domain_length] = Aa
    ...
    vars_vec[idx_psy * domain_length : (idx_psy + 1) * domain_length] = psy
    vars_vec[idx_Pi * domain_length : (idx_Pi + 1) * domain_length] = Pi
